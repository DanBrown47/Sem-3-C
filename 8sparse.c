...
void print_sparse(int b[20][20]);
void create_sparse(int a[10][10], int row, int column, int b[20][20]);

void main()
{
    int a[10][10], b[20][20], row, column;
...
{
    int i, j;
    printf("\nEnter elements of matrix(More zeros)\n");
    for (i = 0; i < row; i++)
    {
        for (j = 0; j < column; j++)
        {
